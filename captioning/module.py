...
class S2VT(nn.Module):
    def __init__(self, vocab_size, batch_size=100, frame_dim=2048, hidden=500, dropout=0.5, n_step=80):
    ...
    def forward(self, video, caption=None):
        ...
        if self.training:
            ...
            #print ("Caption_input: {}".format(caption.shape))
            ...
            #print("Caption_output: {}".format(cap_out.shape))
            return cap_out
