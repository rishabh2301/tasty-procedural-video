...
if __name__ == "__main__":
    ...
    s2vt = s2vt.cuda()
    s2vt.load_state_dict(torch.load("/home/r/rishabhs/tasty_dataset/S2VT_pytorch2/s2vt_params.pkl"))
    s2vt.eval()
    val_result = {}
    ...
    with open("/home/r/rishabhs/tasty_dataset/S2VT_pytorch2/result.json", "a+") as f:
